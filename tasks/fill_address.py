"""
This module defines the FillAddress task for filling the address in the register form.
"""

class FillAddress:
    def __init__(self, company, first_address, second_address, country_id, city, region_id, zip_code):
    ...
    def perform_as(self, actor):
        ...
        actor.page.locator("#AccountFrm_country_id").select_option(self.country_id)
